...
- `jobs/[id]/staffing-preparation/` — 날짜별 가능 여부·본담당/예비 후보·선탑 일정/접선 정보·교육 후 본인 의사·팀 메모/변경 이력 GET/POST. 인증 계정과 입력한 작성자를 기록하며, 같은 기록을 동시에 수정하면 409로 최신 이력을 반환한다 (준비 기록만 저장, 확정·발송 없음).
