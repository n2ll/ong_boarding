    ...
    if (isDanggeun && data.status === "스크리닝 중") {
      try {
        ...
        if (startMsg) {
          ...
          const filled = resolveAutomatedOutboundText(filledStored, fallback);
          if (!filled) {
