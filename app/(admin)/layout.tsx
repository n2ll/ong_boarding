    ...
    >
      <BranchScopeProvider>
        ...
        {/*
          ...
          도크는 fixed라 본문이 lg:ml-[104px]로 자리를 비켜준다(독 우변 88px + 16px — 상·우·하 프레임과 대칭).
        ...
        */}
        <div className="relative flex h-[100dvh] w-full overflow-hidden font-sans">
          ...
          <div className="flex h-[100dvh] w-full min-w-0 flex-col px-3 pb-[calc(5.25rem+env(safe-area-inset-bottom))] lg:ml-[104px] lg:w-[calc(100%-104px)] lg:px-0 lg:pb-4 lg:pr-4">
