...
export default defineConfig({
  ...base,
  testMatch: ["multi-job-consultation.spec.ts", "admin-status-accuracy.spec.ts", "training-contact.spec.ts", "staffing-participation.spec.ts", "staffing-date-board.spec.ts", "staffing-follow-up.spec.ts", "pool-pilot.spec.ts", "jobs-handoff-status.spec.ts"],
  testIgnore: [],
