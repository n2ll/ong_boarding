...
export default defineConfig({
  ...base,
  testMatch: ["multi-job-consultation.spec.ts", "admin-status-accuracy.spec.ts", "training-contact.spec.ts", "staffing-participation.spec.ts", "staffing-date-board.spec.ts", "staffing-demand.spec.ts", "staffing-follow-up.spec.ts", "staffing-simple-entry.spec.ts", "staffing-note-draft.spec.ts", "pool-pilot.spec.ts", "jobs-handoff-status.spec.ts"],
  testIgnore: [],
