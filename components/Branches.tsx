        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="bg-input-background/90 font-medium shadow-inset hover:border-foreground/25 min-h-11 pl-9 pr-4 py-2.5 border border-border-strong rounded-2xl text-sm w-[280px] focus:outline-none focus-visible:border-foreground/35 focus-visible:ring-2 focus-visible:ring-ring"
            />
          </div>
          <button
            onClick={openCreate}
