  ...
  return (
    <div className={embedded ? "flex flex-col" : "p-8 pb-12 flex flex-col h-full overflow-y-auto [&>*]:shrink-0"}>
      ...
      <Modal
        ...
        description="이름만 넣어도 저장됩니다. 나머지는 나중에 채워도 됩니다."
        footer={
        ...
        {form && (
          <div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
            <TextField
              ...
              placeholder="예: OO도시락 · 우아한형제들(비마트)"
            />
            <SelectField
              label="유형"
            ...
            <ToggleRow
              label="확정슬롯 사용"
              description="지점×타임×요일로 구인"
              checked={form.uses_slots}
              onChange={(v) => setForm({ ...form, uses_slots: v })}
            ...
            <ToggleRow
              full
              label="활성 상태"
              description="끄면 공고 등록 시 이 화주사가 목록에 뜨지 않습니다"
              checked={form.active}
