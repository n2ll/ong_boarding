 ...
 * in-flow 면) → 콘텐츠 레벨(card/warm — 불투명·무블러). 애매하면 스크롤해 보라.
 *
 ...
 * - level warm: 웜 존 — 긴급·문제 콘텐츠 전용(쿨 존은 2026-08-18 사용자 기각).
 *   항상 라벨·아이콘 동반(색만으로 상태 전달 금지).
 *
 * 규칙
 ...
 *   스크롤 프레임을 깎는다(칸반 300장 실측). 반복 요소는 card/warm만.
