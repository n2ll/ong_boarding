 ...
 *   "min-h-11 w-full px-4 py-3 border border-border-strong rounded-md text-sm
...
export const controlBase =
  "w-full rounded-md border border-control-border bg-input-background/90 px-3.5 text-[14px] font-medium text-foreground shadow-inset outline-none transition-[background-color,border-color,box-shadow] duration-150 placeholder:font-normal placeholder:text-muted-foreground/70 hover:border-foreground/55 focus-visible:border-foreground/65 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-55 aria-[invalid=true]:border-error aria-[invalid=true]:focus-visible:ring-error";
...
function ToggleRow({
  ...
  return (
    <button
      ...
      className={cn(
        "flex min-h-[3.25rem] w-full items-center justify-between gap-3 rounded-md border border-control-border bg-input-background/70 px-3.5 py-2.5 text-left outline-none transition-colors hover:border-foreground/55 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-55",
        full && "col-span-full",
        className,
      )}
    >
