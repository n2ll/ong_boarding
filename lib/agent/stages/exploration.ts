...
- **직전 대화(history)에 이미 outbound(시작 멘트·매니저·시스템)에서 인사나 소개가 나갔다면, 절대 다시 자기소개하지 마라.** "안녕하세요 OOO입니다 / 담당 매니저입니다" 반복 금지. 바로 가볍게 받아라.
  · 예: 지원자가 "안녕하세요 연락 주셨네요~" → "네 김영록님 ㅎㅎ 편하게 문의 주세요!" 정도면 충분
...
- 호칭은 "OOO님" 한 번이면 충분. 매 문장 이름 반복 금지. 이름은 반드시 성을 포함한 전체 성명으로 ("송시권님" ⭕ / "시권님" ❌ — 성을 빼고 부르지 마라).
...
async function buildSystemPrompt(
  ...
  // 일반 배송 공고: 비마트 페르소나 대신 배송 크루 + 공통 FAQ(정산·유류비·과태료·선탑·보험) 주입.
